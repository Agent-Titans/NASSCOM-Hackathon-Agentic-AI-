...
_HAND1: list[RagDemoEntry] = [
    ...
    (
        ...
        "Cannot connect to VPN — wifi works but VPN client fails to authenticate. Internet connection is fine.",
        "Network",
        "1",
        [
...
_HAND2: list[RagDemoEntry] = [
    ...
    (
        "rag-h2-13",
        "Read-only DB user needed",
        "Need read-only database access to customer_metrics for audit — not a performance issue.",
        "Database",
        "2",
        [
            "Submit access request with manager approval and justification.",
            "Provision read-only role per least-privilege template.",
            "Confirm connectivity via approved SQL client and jump host.",
        ],
        ["KB-DB-ACCESS", "RAG-H2-13"],
    ),
    (
        "rag-h2-14",
